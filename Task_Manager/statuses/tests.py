...
class TestStatusesView(TestCase):
    def setUp(self):
        ...
        Status.objects.create(name='test_status_1')
        Status.objects.create(name='test_status_2')

    def test_statuses_with_uknown_user(self):
    ...
    def test_statuses(self):
        ...
        self.assertContains(response, 'test_status_1', status_code=200)
        self.assertContains(response, 'test_status_2', status_code=200)
...
class TestCreateStatusView(TestCase):
    ...
    def test_create_status_get_with_uknown_user(self):
...
class TestDeleteStatusView(TestCase):
    ...
    def test_delete_status_get_with_uknown_user(self):
    ...
    def test_delete_status_user_with_task(self):
        self.client.login(
            username=test_user['username'],
            password=test_user['password']
        )
        ...
        Task.objects.create(
            name='test_task',
            status=status,
            author=get_user_model().objects.get(username=test_user['username'])
        )
        response = self.client.post(reverse_lazy(
        ...
        self.assertTrue(Status.objects.filter(name='Test_status_1'))
...
class TestUpdateStatusView(TestCase):
    ...
    def test_update_status_get_with_uknown_user(self):
        response = self.client.get(reverse_lazy(
