...
class TestIndex(TestCase):
    ...
    def test_index_with_uknown_user(self):
...
class TestIndexEnglishVersion(TestCase):
    def setUp(self):
        model = get_user_model()
        model.objects.create_user(username='test', password='test')
...
class TestLoginEnglishVersion(TestCase):
    def setUp(self):
        model = get_user_model()
        model.objects.create_user(username='test', password='test')
        self.client.cookies.load({settings.LANGUAGE_COOKIE_NAME: "en-US"})
...
class TestLogoutEnglishVersion(TestCase):
    def setUp(self):
        model = get_user_model()
        model.objects.create_user(username='test', password='test')
